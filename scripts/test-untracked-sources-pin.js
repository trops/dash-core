 ...
 *
 * Why this pin exists: in May 2026 dash-core shipped v0.1.484 with
 * electron/utils/transform.js requiring `./safeJsExecutor`, but the
 * helper file was never committed. ci.sh's `git add -u` skipped the
 * untracked file, the merge landed without it, and the npm publish
 * workflow's rollup build failed with "Could not resolve
 * './safeJsExecutor'". The checker fails the release loudly when
 * untracked sources exist.
 *
 * Pin enforces:
