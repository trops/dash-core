...
node --test electron/mcp/permissionGate.test.js electron/mcp/grantedPermissions.test.js electron/utils/mcpServerKey.test.js electron/utils/mcpScopeResolver.test.js electron/utils/manifestScanner.test.js electron/controller/widgetMcpGrantsListing.test.js electron/mcp/jitConsent.test.js electron/utils/securityFlags.test.js electron/security/fsGate.test.js electron/security/networkGate.test.js electron/api/secureStoreApi.test.js electron/api/algoliaApi.test.js electron/api/layoutApi.test.js electron/api/clientCacheApi.test.js electron/controller/schedulerController.test.js electron/controller/notificationController.test.js
