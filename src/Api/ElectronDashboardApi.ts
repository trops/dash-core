...
class ElectronDashboardApi implements IDashboardApi {
  ...
  saveProvider(appId, providerName, providerData, onSuccess, onError): Boolean {
    if (this.api !== null) {
      try {
        // Handle the promise returned by the IPC call
    ...
    if (this.api !== null) {
      try {
        this.api.workspace
          ...
          .then((result) => {
            onSuccess(this.events.WORKSPACE_DELETE_COMPLETE, result);
          })
          .catch((error) => {
      ...
      onError(this.events.WORKSPACE_DELETE_ERROR, new Error("No Api found"));
      return false;
    }
  }
    ...
    if (this.api !== null) {
      try {
        this.api.menuItems
          ...
          .then((result) => {
            onSuccess(this.events.MENU_ITEMS_DELETE_COMPLETE, result);
          })
          .catch((error) => {
      ...
      onError(this.events.MENU_ITEMS_DELETE_ERROR, new Error("No Api found"));
      return false;
    }
  }
  ...
  mcpStartServer(
    ...
    if (this.api !== null) {
      ...
      onError(this.events.MCP_START_SERVER_ERROR, new Error("No Api found"));
      return false;
    }
  }
  ...
  mcpStopServer(serverName, onSuccess, onError): Boolean {
    if (this.api !== null) {
      ...
      onError(this.events.MCP_STOP_SERVER_ERROR, new Error("No Api found"));
      return false;
    }
  }
  ...
  mcpListTools(serverName, onSuccess, onError): Boolean {
    if (this.api !== null) {
      ...
      onError(this.events.MCP_LIST_TOOLS_ERROR, new Error("No Api found"));
      return false;
    }
  }
  ...
  mcpListResources(serverName, onSuccess, onError): Boolean {
    if (this.api !== null) {
      ...
      onError(this.events.MCP_LIST_RESOURCES_ERROR, new Error("No Api found"));
      return false;
    }
  }
  ...
  mcpReadResource(serverName, uri, onSuccess, onError): Boolean {
    if (this.api !== null) {
      ...
      onError(this.events.MCP_READ_RESOURCE_ERROR, new Error("No Api found"));
      return false;
    }
  }
  ...
  mcpGetServerStatus(serverName, onSuccess, onError): Boolean {
    if (this.api !== null) {
      ...
      onError(this.events.MCP_SERVER_STATUS_ERROR, new Error("No Api found"));
      return false;
    }
  }
