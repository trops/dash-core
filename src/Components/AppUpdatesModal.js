...
export const AppUpdatesModal = ({
  ...
  // Preflight consent is its own dialog. When the batch suspends for
  // permission approval, render the shared WidgetPreflightReview inside
  // this modal's shell (same Modal chrome as before the extraction) and
  // short-circuit the normal updates/checking/up-to-date body. The
  // hook clears pendingPreflight when the user resolves, returning the
  // modal to its normal mode.
  if (pendingPreflight) {
    return (
