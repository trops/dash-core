            ...
            <div className="flex flex-col rounded p-6 space-y-4 w-1/3">
              ...
              <div className="flex-col hidden 2xl:flex w-full space-y-4">
                <SubHeading3
                  ...
                  padding={false}
                />
                <Paragraph padding={false} textColor={"text-gray-400"}>
                  Dashboards have been generated by exporting, and storing the
                  layouts in an Algolia index. Search the index for Dashboards
                  to load.
                </Paragraph>
              </div>
            </div>
            <div className="flex flex-col w-2/3 space-y-2">
              {searchClient !== null && (
                <InstantSearch
                  ...
                  indexName={indexName}
                >
                  <AlgoliaSearchBox placeholder={"Search for Dashboards"} />
