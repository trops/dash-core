      ...
      },
      {
        ...
        render: () => (
          <Card>
            ...
            <Card.Body>
              <Paragraph text="Card content goes here." padding={false} />
            </Card.Body>
          </Card>
        ),
      },
        ...
        render: () => (
          <Tabs defaultValue="tab1">
            ...
            <Tabs.Content value="tab1">
              <Paragraph text="Tab content here." padding={false} />
            </Tabs.Content>
            <Tabs.Content value="tab2">
              <Paragraph text="Second tab content." padding={false} />
            </Tabs.Content>
          </Tabs>
        ),
      },
        ...
        render: () => (
          <Accordion type="single" defaultValue={["section1"]}>
            <Accordion.Item value="section1">
              <Accordion.Trigger value="section1">Section 1</Accordion.Trigger>
              <Accordion.Content value="section1">
                Accordion content for section one.
              </Accordion.Content>
            </Accordion.Item>
            <Accordion.Item value="section2">
              <Accordion.Trigger value="section2">Section 2</Accordion.Trigger>
      ...
      },
      {
        ...
        render: () => (
          <Card2>
            ...
            <Card2.Body>
              <Paragraph2 text="Card content goes here." padding={false} />
            </Card2.Body>
          </Card2>
        ),
      },
        ...
        render: () => (
          <Tabs2 defaultValue="tab1">
            ...
            <Tabs2.Content value="tab1">
              <Paragraph2 text="Tab content here." padding={false} />
            </Tabs2.Content>
            <Tabs2.Content value="tab2">
              <Paragraph2 text="Second tab content." padding={false} />
            </Tabs2.Content>
          </Tabs2>
        ),
      },
      ...
      },
      {
        ...
        render: () => (
          <Card3>
            ...
            <Card3.Body>
              <Paragraph3 text="Card content goes here." padding={false} />
            </Card3.Body>
          </Card3>
        ),
      },
        ...
        render: () => (
          <Tabs3 defaultValue="tab1">
            ...
            <Tabs3.Content value="tab1">
              <Paragraph3 text="Tab content here." padding={false} />
            </Tabs3.Content>
            <Tabs3.Content value="tab2">
              <Paragraph3 text="Second tab content." padding={false} />
            </Tabs3.Content>
          </Tabs3>
        ),
      },
...
export const PanelTheme = ({ onUpdate, theme = null, themeKey, rawTheme }) => {
  ...
  function renderAllTiers() {
    ...
    const tierSections = [1, 2, 3].map((tier) => {
      const { PanelComponent, panelKey, components } = TIER_COMPOSITES[tier];
      ...
      return (
        <div key={tier} className="flex flex-col space-y-2">
          ...
          <div
            ...
            onClick={() => {
              const clickStyles = getStylesForItem(panelKey, themeData);
              handleSelectComponent({
                item: panelKey,
                styles: clickStyles,
              });
            ...
            >
              <PanelComponent.Body>
                <div className="flex flex-col space-y-3 p-2">
                  {components.map((comp) => {
                    if (comp.render) {
                      return renderComponentRow(comp.key, comp.render());
                    }
                    const { children: childContent, ...restProps } = comp.props;
        ...
        >
          <Panel.Body>
            <div className="flex flex-col space-y-3 p-2">
              ...
              {renderComponentRow("switch", <Switch label="Dark mode" />)}
            </div>
          </Panel.Body>
        </Panel>
      </div>
          ...
          <Panel.Body>
            <div className="flex flex-col space-y-3 p-2">
              ...
              {renderComponentRow(
                "data-list",
                <DataList>
                  <DataList.Item label="Name" value="John Doe" />
              ...
              <div className="flex flex-row overflow-clip space-x-1 h-full rounded bg-black w-full p-1">
                <div className="flex flex-col h-full w-1/4 min-w-[25%] max-w-[25%] overflow-clip">
                  <div className="flex flex-col h-full space-y-2 border-r border-gray-700 p-2 w-full">
                    <Tabs3 value={leftPanelTab} onValueChange={setLeftPanelTab}>
                      <Tabs3.List className="w-full">
                        <Tabs3.Trigger value="palette">Colors</Tabs3.Trigger>
                    ...
                    {leftPanelTab === "components" && (
                      <ComponentSelectorPane
                        ...
                        rawTheme={rawTheme}
                        selectedComponent={
                          itemSelected ? itemSelected["item"] : null
                        }
                    ...
                    >
                      {showPreview ? (
                        <PreviewComponentsPane
                          ...
                          selectedComponent={itemSelected?.item || null}
                        />
                      ) : (
                  ...
                  {itemSelected !== null && (
                    <div
                      className={`flex flex-col rounded bg-gray-800 space-y-4 overflow-clip ${
                        itemColorSelected !== null ? "h-1/2" : "h-full"
                      }`}
                    >
                    ...
                    <div className="flex flex-col rounded bg-gray-800 space-y-4 overflow-clip h-1/2">
                      <div className="flex flex-col bg-gray-900 p-3 rounded-t border-b border-gray-700 border-l-2 border-l-yellow-500">
                        <span className="text-sm font-bold text-yellow-300">
                          {isColorProperty(itemColorSelected.styleName)
                            ? "Theme Tokens"
                            : "Values"}
                        </span>
                            ...
                            onPreview={(value) => {
                              try {
                                if (rawTheme) {
                                  ...
                                  newTheme[themeVariant][
                                    itemColorSelected.itemType
                                  ][itemColorSelected.styleName] = value;
                                  onUpdate(newTheme, themeKey);
                                }
                              } catch (e) {
