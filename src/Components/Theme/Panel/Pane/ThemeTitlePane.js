...
import { Heading, ButtonIcon, Toggle } from "@trops/dash-react";

const ThemeTitlePane = ({ onChooseVariant, onClickNewTheme }) => {
      ...
      <div className="flex flex-col rounded font-medium justify-between overflow-clip">
        <div className="flex flex-col rounded p-6 py-10 space-y-4 w-full hidden xl:flex">
          ...
          <p className={`text-lg font-normal text-gray-300`}>
            ...
            <span className="italic">have</span> to change colors, we'll allow
            it.
          </p>
          <div className="flex flex-col space-y-2 w-full">
            <Toggle
              ...
              setEnabled={() =>
                onChooseVariant(themeVariant === "dark" ? "light" : "dark")
              }
              text={"Dark"}
              theme={false}
