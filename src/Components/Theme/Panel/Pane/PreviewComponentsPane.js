...
import { getCSSStyleForClassname, getStylesForItem } from "@trops/dash-react";
import { themeObjects } from "@trops/dash-react";
...
const PreviewComponentsPane = ({ theme, themeVariant, onClick }) => {
  ...
  function renderPanels() {
    console.log("render panels theme ", theme);
      ...
      <div className="flex flex-col space-y-4 p-4">
        <div className="flex flex-row bg-gray-900 p-4 space-x-4 rounded justify-between">
          <Panel {...styles} scrollable={false} className="rounded">
            ...
            ></Panel.Body>
            <Panel.Footer className={"text-xs uppercase font-light"}>
              {getCSSStyleForClassname("backgroundColor", themeObjects.PANEL)}
            </Panel.Footer>
          </Panel>
          <Panel2 className={"rounded"} {...styles2} scrollable={false}>
            <Panel2.Header className={"text-xs uppercase font-bold"}>
              Panel 2
            </Panel2.Header>
            <Panel2.Body
              {...styles2}
            ...
            ></Panel2.Body>
            <Panel2.Footer className={"text-xs uppercase font-light"}>
              {getCSSStyleForClassname("backgroundColor", themeObjects.PANEL_2)}
            </Panel2.Footer>
          </Panel2>
          <Panel3 className={"rounded"} {...styles3} scrollable={false}>
            <Panel3.Header className={"text-xs uppercase font-bold"}>
              Panel 3
            </Panel3.Header>
            <Panel3.Body
              {...styles3}
            ...
            ></Panel3.Body>
            <Panel3.Footer className={"text-xs uppercase font-light"}>
              {getCSSStyleForClassname("backgroundColor", themeObjects.PANEL_3)}
            </Panel3.Footer>
          </Panel3>
        </div>
        ...
        >
          <Heading
            ...
            {...headingStyles}
            padding={false}
            onClick={() => handleClickItem(themeObjects.HEADING, headingStyles)}
          />
          <Heading2
            title={"Heading 2"}
            {...heading2Styles}
          ...
          <SubHeading
            ...
            padding={false}
            onClick={() =>
              handleClickItem(themeObjects.SUBHEADING, subHeadingStyles)
            }
          />
          <SubHeading2
            title={"Subheading 2"}
            ...
            padding={false}
            onClick={() =>
              handleClickItem(themeObjects.SUBHEADING_2, subHeading2Styles)
            }
          />
          <SubHeading3
            title={"Subheading"}
            ...
            padding={false}
            onClick={() =>
              handleClickItem(themeObjects.SUBHEADING_3, subHeading3Styles)
            }
          />
          <Paragraph
          ...
          <Paragraph2
            ...
            padding={false}
            onClick={() =>
              handleClickItem(themeObjects.PARAGRAPH_2, paragraph2Styles)
            }
          />
          <Paragraph3
            text={"The quick brown fox jumps over the lazy dog."}
            ...
            padding={false}
            onClick={() =>
              handleClickItem(themeObjects.PARAGRAPH_3, paragraph3Styles)
            }
          />
          <div className="flex flex-row space-x-2 w-full">
            <Button
              title="Button"
              {...buttonStyles}
              onClick={() => handleClickItem(themeObjects.BUTTON, buttonStyles)}
            />
            <Button2
              title="Button 2"
              {...button2Styles}
          ...
          <div className="flex flex-row space-x-4 w-full h-fit">
            <div className="flex flex-row space-x-2">
              <ButtonIcon
                ...
                {...buttonIconStyles}
                onClick={() =>
                  handleClickItem(themeObjects.BUTTON_ICON, buttonIconStyles)
                }
              />
              <ButtonIcon
                icon="pencil"
            ...
            <div className="flex flex-row space-x-2">
              <ButtonIcon
                ...
                {...buttonIconStyles}
                onClick={() =>
                  handleClickItem(themeObjects.BUTTON_ICON_2, buttonIcon2Styles)
                }
              />
              <ButtonIcon
                icon="pencil"
            ...
            <div className="flex flex-row space-x-2">
              <ButtonIcon
                ...
                {...buttonIcon3Styles}
                onClick={() =>
                  handleClickItem(themeObjects.BUTTON_ICON_3, buttonIcon3Styles)
                }
              />
              <ButtonIcon
                icon="pencil"
          ...
          <div className="flex flex-col space-y-2 w-full">
            <MenuItem
              {...menuItemStyles}
              onClick={() =>
                handleClickItem(themeObjects.MENU_ITEM, menuItemStyles)
              }
            >
              Menu Item
            </MenuItem>
            <MenuItem2
              {...menuItem2Styles}
              onClick={() =>
                handleClickItem(themeObjects.MENU_ITEM_2, menuItem2Styles)
              }
            >
              Menu Item 2
            </MenuItem2>
            <MenuItem3
              {...menuItem3Styles}
              onClick={() =>
                handleClickItem(themeObjects.MENU_ITEM_3, menuItem3Styles)
              }
            >
              Menu Item 3
            </MenuItem3>
          ...
          <div className="flex flex-row space-x-2 w-full">
            <Tag
              ...
              icon="pencil"
              {...tagStyles}
              onClick={() => handleClickItem(themeObjects.TAG, tagStyles)}
            />
            <Tag2
              text="Tag 2"
              icon="pencil"
              {...tag2Styles}
              onClick={() => handleClickItem(themeObjects.TAG_2, tag2Styles)}
            />
            <Tag3
              text="Tag 3"
              icon="pencil"
              {...tag3Styles}
              onClick={() => handleClickItem(themeObjects.TAG_3, tag3Styles)}
            />
          </div>
        </Panel>
        ...
        >
          ...
          <Paragraph2
            ...
            padding={false}
            onClick={() =>
              handleClickItem(themeObjects.PARAGRAPH, paragraph2Styles)
            }
          />
          <Paragraph3
            text={"The quick brown fox jumps over the lazy dog."}
        ...
        >
          ...
          <ButtonIcon2
            ...
            {...buttonIcon2Styles}
            onClick={() =>
              handleClickItem(themeObjects.BUTTON_ICON_2, buttonIconStyles)
            }
          />
          <MenuItem2
            {...menuItem2Styles}
