    ...
    return (
      <div className="flex flex-col space-y-4 p-4">
        ...
        <SubHeading
          ...
          {...subHeadingStyles}
          padding={false}
          onClick={() => handleClickItem("subHeading", subHeadingStyles)}
        />
        <SubHeading2
          title={"Subheading 2"}
          {...subHeading2Styles}
          padding={false}
          onClick={() => handleClickItem("subHeading2", subHeading2Styles)}
        />
        <SubHeading3
          title={"Subheading 3"}
          {...subHeading3Styles}
          padding={false}
          onClick={() => handleClickItem("subHeading3", subHeading3Styles)}
        />
        <Paragraph
          text={"The quick brown fox jumps over the lazy dog."}
          {...paragraphStyles}
          padding={false}
          onClick={() => handleClickItem("paragraph", paragraphStyles)}
        />
        <Paragraph2
          text={"The quick brown fox jumps over the lazy dog."}
          {...paragraph2Styles}
          padding={false}
          onClick={() => handleClickItem("paragraph2", paragraph2Styles)}
        />
        <Paragraph3
          text={"The quick brown fox jumps over the lazy dog."}
          {...paragraph3Styles}
          padding={false}
          onClick={() => handleClickItem("paragraph3", paragraph3Styles)}
        />
      </div>
    );
  }
            ...
            {theme !== null && (
              ...
              >
                ...
                <ThemePane>
                  <Panel
                    padding={false}
                    className={"p-4 rounded h-full overflow-y-scroll"}
                    scrollable={false}
                    {...getStylesForItem(
                      themeObjects.PANEL,
                      theme[themeVariant],
                ...
                {itemColorSelected !== null && itemSelected !== null && (
                  <AvailableColorsPane
                    onChooseColor={handleSelectColorForItem}
                  />
                )}
              </div>
            )}
