...
export const LayoutBuilderAddItemModal = ({
  ...
  function renderMenuItem(type, componentName) {
    ...
    return (
      <MenuItem3
        ...
        onClick={() => handleClickItem({ type, component: componentName })}
      >
        {componentName}
      </MenuItem3>
    );
  ...
  function renderCompatibleWidgets() {
    try {
      ...
      if (menuItemSelected) {
        const widgets = ComponentManager.getCompatibleWidgetsForWorkspace(
                ...
                {menuItemSelected === null && (
                  <div className="flex-col h-full rounded font-medium text-gray-400 w-full xl:w-full p-10">
                    ...
                    <div className="flex flex-col rounded p-4 py-10 space-y-4">
                      <Heading title="Build." padding={false} />
                      <SubHeading3
                        title={"Pick a Widget to add to your Dashboard Layout."}
                        padding={false}
                      />
                      <Paragraph
