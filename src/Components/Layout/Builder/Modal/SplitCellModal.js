    ...
    if (direction === "horizontal") {
      ...
      for (let i = 0; i < cellCount; i++) {
        cells.push(
          ...
          >
            <span className="text-gray-400 text-sm">Cell {i + 1}</span>
          </div>,
        );
      }
      ...
      return <div className="flex flex-col space-y-2 h-64 w-full">{cells}</div>;
    }
  };
      ...
      <Panel border={true} padding={true}>
        ...
        <Panel.Body>
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex space-x-4">
                <Button
                  ...
                  backgroundColor={
                    direction === "horizontal" ? "bg-blue-600" : "bg-gray-700"
                  }
                ...
                <Button
                  ...
                  backgroundColor={
                    direction === "vertical" ? "bg-blue-600" : "bg-gray-700"
                  }
                  hoverBackgroundColor="hover:bg-blue-500"
                  className="flex-1"
                >
            ...
            {/* Cell count slider */}
            <div className="flex flex-col space-y-2">
              <SubHeading3>Number of Cells: {cellCount}</SubHeading3>
              <input
                type="range"
                min="2"
                max="4"
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="bg-gray-900 rounded p-4">{renderPreview()}</div>
            ...
            {gridContainer?.grid?.[cellNumber]?.component && (
              <div className="bg-yellow-900 border border-yellow-700 rounded p-3 text-yellow-200 text-sm">
                ...
                This cell contains a widget. The widget will be removed during
                the split.
              </div>
            )}
          </div>
