...
import { FontAwesomeIcon, withRouter } from "@trops/dash-react";
...
class SideMenu extends React.Component {
  ...
  generateNavigation = () => {
    ...
    application !== undefined &&
      navigation.push({
        ...
        children:
          indexName &&
          this.generateApplicationChildren(
            pages,
            templates,
            queries,
            indexName,
  ...
  render() {
    ...
    return (
      <div className="flex flex-col border-r border-gray-800 pb-4 overflow-y-scroll h-full scrollbar scrollbar-thumb-gray-700 scrollbar-thin scrollbar-track-transparent">
            ...
            {navigation.map((item) =>
              !item.children ? (
                ...
                >
                  ...
                  <span className="hidden 2xl:inline-flex ml-2">
                    {item.name}
                  </span>
                </Link>
              ) : (
        ...
        <div>
          <Disclosure as="div" key={"menu-settings"} className="px-4 2xl:px-4">
            ...
            >
              <FontAwesomeIcon icon="gear" className="text-gray-500" />
              <span className="hidden 2xl:inline-flex">Settings</span>
            </Disclosure.Button>
          </Disclosure>
        </div>
      </div>
