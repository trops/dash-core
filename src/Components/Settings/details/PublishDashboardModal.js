    ...
    async function handlePublish() {
        ...
        try {
            ...
            setResult({
                ...
                error:
                    err.message ||
                    "Failed to prepare dashboard for publish.",
            });
        } finally {
            setIsPublishing(false);
        }
            ...
            >
                ...
                >
                    ...
                    <Stepper.Step label="Details">
                        <div className="flex-1 min-h-0 overflow-y-auto pb-4 space-y-5">
                            <p className="text-sm opacity-70">
                                Provide details about your dashboard for the
                                registry listing.
                            </p>
                            <InputText
                                label="Author Name *"
                    ...
                    <Stepper.Step label="Tags">
                        <div className="flex-1 min-h-0 overflow-y-auto pb-4 space-y-5">
                            <p className="text-sm opacity-70">
                                Select at least one tag to categorize your
                                dashboard.
                            </p>
                    ...
                    <Stepper.Step label="Publish">
                        <div className="flex-1 min-h-0 overflow-y-auto pb-4 space-y-4">
                            {!result ? (
                                <>
                                    <p className="text-sm opacity-70">
                                        Review your dashboard details before
                                        publishing.
                                    </p>
                                            ...
                                            <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 space-y-2">
                                                <div className="flex items-start gap-2">
                                                    ...
                                                    <span className="text-xs text-amber-300/90">
                                                        ...
                                                        registry. This may be
                                                        intentional if they are
                                                        private. Dashboards
                                                        referencing these
                                                        widgets can only be
                                                        installed by users who
                                                        already have them.
                                                    </span>
                                                </div>
                                    ...
                                    {result.registryCheckFailed && (
                                        <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3">
                                            <div className="flex items-start gap-2">
                                                ...
                                                />
                                                <span className="text-xs text-amber-300/90">
                                                    Unable to reach the registry
                                                    to verify widget
                                                    availability. Your dashboard
                                                    was still prepared
                                                    successfully.
                                                </span>
                                            </div>
