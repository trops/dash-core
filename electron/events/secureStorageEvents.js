const SECURE_STORE_ENCRYPTION_CHECK = "secure-storage-encryption-check";
const SECURE_STORE_ENCRYPTION_CHECK_COMPLETE =
  "secure-storage-encryption-check-complete";
const SECURE_STORE_ENCRYPTION_CHECK_ERROR =
  "secure-storage-encryption-check-error";

const SECURE_STORAGE_ENCRYPT_STRING = "secure-storage-encrypt-string";
const SECURE_STORAGE_ENCRYPT_STRING_COMPLETE =
...
module.exports = {
  ...
  SECURE_STORAGE_ENCRYPT_STRING_COMPLETE,
  SECURE_STORAGE_ENCRYPT_STRING_ERROR,
};
