...
const settingsController = {
  ...
  getDataDirectory: (win) => {
    try {
      ...
      console.error("[settingsController] Error getting data directory:", e);
      return {
        error: true,
        message: e.message,
      };
  ...
  setDataDirectory: (win, newPath) => {
    try {
      ...
      console.error("[settingsController] Error setting data directory:", e);
      return {
        error: true,
        message: e.message,
      };
    ...
    try {
      ...
      for (const prefix of blockedPrefixes) {
        if (
          ...
          throw new Error("Cannot migrate to a system directory: " + prefix);
        }
      }
      ...
      console.error("[settingsController] Error migrating data directory:", e);
      return {
        error: true,
        message: e.message,
      };
